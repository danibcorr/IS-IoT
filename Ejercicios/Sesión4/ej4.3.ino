...
// Zumbador y Boton
// ---------- Constantes ----------
const unsigned long UMBRAL_REBOTE = 20; // milliseg
const byte PinBoton = 4;
const byte PinZumbador = 3;
const byte IncZumbador = 10;
const unsigned long CICLO_ZUMBADOR = 100; // miliseg
...
const int melodia[] = {
  ...
  NOTE_E5, NOTE_E5, NOTE_F5, NOTE_G5, NOTE_G5, NOTE_F5, NOTE_E5, NOTE_D5,
  NOTE_C5, NOTE_C5, NOTE_D5, NOTE_E5, NOTE_D5, NOTE_C5
};
